...
namespace Enigma
{
    public partial class FrmRotorMAndRingM : Form
    {

        private readonly string enigmaXmlFilePath = "RotorMAndRingM.xml";
        int _width;

        public static GroupBox ownerGBX;

        public FrmRotorMAndRingM()
        {
            InitializeComponent();
        }

        private void FrmRotorMAndRingM_Load(object sender, EventArgs e)
        {
        ...
        private void FrmRotorMAndRingM_Resize(object sender, EventArgs e)
        {
            if (_width != this.ClientSize.Width && _width != 0)
            {
                ...
                column = DgvDtRotorMAndRingM.Columns[11];
                column.Width += widthDifference / 2;
                column = DgvDtRotorMAndRingM.Columns[12];
                column.Width += widthDifference / 2;
            }
            _width = this.ClientSize.Width;
        }
        ...
        private void DtRotorMAndRingMBindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            try
            {
                this.Validate();

                dtRotorMAndRingMBindingSource.EndEdit();
                ...
                dtRotorMAndRingMBindingNavigator.Refresh();
                dtRotorMAndRingMBindingNavigator.Update();
                ...
                dtRotorMAndRingMBindingNavigator.Refresh();
                dtRotorMAndRingMBindingNavigator.Update();
                dtRotorMAndRingMBindingNavigatorSaveItem.Enabled = false;
            }
            catch (Exception ex)
            {
        ...
        private void BGWCipher_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            Challenge10Scans.RotorMAndRingM();
        }
        ...
        private void CreateDataGridViewDATA(string infoText)
        {
            ...
            DataTable table = this.dsEnigmaChallenges.Tables[2];
            ...
            this.dsEnigmaChallenges.Tables[2].Rows.Add(myDataRow);
            dtRotorMAndRingMBindingNavigatorSaveItem.Enabled = true;
        }
